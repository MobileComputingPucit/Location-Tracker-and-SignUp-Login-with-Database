        ...
        auth.createUserWithEmailAndPassword(uname, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(getApplicationContext(), "Mechanic registered successfully", Toast.LENGTH_SHORT).show();
                ...
                else
                {
                    ...
                    {
                        Toast.makeText(getApplicationContext(), "Mechanic is already registered", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
